...
class RegisterRestaurantScreenView extends StatefulWidget {
  const RegisterRestaurantScreenView({super.key});
          ...
          child: Column(
            children: <Widget>[
              ...
              EmailTextField(
                ...
                onFiledSubmitted: () {
                  FocusScope.of(context).requestFocus(restaurantName);
                },
                textInputAction: TextInputAction.next,
              ...
              EmailTextField(
                ...
                onFiledSubmitted: () {
                  FocusScope.of(context).requestFocus(phoneRestaurantFocusNode);
                },
                textInputAction: TextInputAction.next,
                controller: restaurantManagerNameController,
                focusNode: restaurantManagerName,
              ),
              Gaps.vGap8,
              PhoneNumberTextField(
                ...
                onInputChanged: (code) => countryCode = code,
                //onDialChanged: (dial)=>countryDial=dial,
                textEditingController: phoneRestaurantController,
                isoCode: countryCode,
                focusNode: phoneRestaurantFocusNode,
                onFieldSubmitted: () {
